 ...
 *
 */
public class DoubleSSLClientApp {

	private SSLSocket clientSSLSocket = null;
	private int serverPort = 8888;
	public DoubleSSLClientApp(){
		/**
		 * 清除以前的Java系统的环境变量
		 */
		...
		/**
		 * 本示例的数九寒天证书库的类型为JKS，如果为PKCS#12，则设置为PKCS12
		 */
	...
	public static void main(String[] args) {
		DoubleSSLClientApp sslClientApp = new DoubleSSLClientApp();
